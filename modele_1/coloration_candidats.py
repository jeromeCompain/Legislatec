...
surpop_file=open("surpopulation.txt","w")
...
def premier_tour (score_macron, score_lepen, score_meluche, score_filou, score_hamon, score_nda,LFI,PCF,EELV,PS,EM,UDI,LR,DLF,FN):
	...
	if EELV and not PS and not PCF:
		meluche2pcf=0
		hamon2pcf=0
		lepen2pcf=0
		macron2pcf=0
	...
	if PS and not EELV and PCF and EM:
		meluche2eelv=0
		hamon2eelv=0
		lepen2eelv=0
		macron2eelv=0
	...
	if PS and not EELV and PCF and not EM:
		meluche2eelv=0
		hamon2eelv=0
		lepen2eelv=0
		macron2eelv=0
	...
	if PS and EELV and not EM and PCF:
		meluche2em=0
		hamon2em=0
		lepen2em=0
		macron2em=0
	...
	if not PS and EELV and EM and PCF:
		meluche2ps=0
		hamon2ps=0
		lepen2ps=0
		macron2ps=0
